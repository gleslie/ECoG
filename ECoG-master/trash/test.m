...
end_data_dir = '/Users/robertjquon/Desktop/sound_study1/testprocessed'
timestamps_filename = '/Users/robertjquon/Desktop/sound_study1/table_sound1.xlsx';
% ImportDataSetNumber = 6; %% Change this to the dataset in the list you want to import.
...
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 2,'setname','all resampled filtered','gui','off');
EEG = eeg_checkset( EEG );

% Compute Average Reference
EEG = pop_reref( EEG, []);
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 3,'setname','all resampled filtered rereferenced','gui','off'); 
...
for j = 1:length(index)
    idx1 = cell2mat(tablesound11(index(j),3));
    idx2 = cell2mat(tablesound11(index(j),4));
    trial_data{index(j)} = EEG.data(:,idx1:idx2);
end

end


save([end_data_dir '/trial_data_downsampled'], 'trial_data', '-v7.3')
